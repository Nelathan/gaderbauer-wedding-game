    ...
    <div class="max-w-2xl w-full">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-lg text-wedding-600 leading-relaxed">
          Kombiniere drei Codewörter von den Karten, um ein vollständiges Haiku zu bilden!
        </p>
      ...
      <div class="card max-w-lg mx-auto">
        ...
        <div v-if="timeoutRemaining > 0" class="mb-6 text-center">
          <div class="timeout-warning p-4 bg-red-50 rounded-lg border border-red-200">
            ...
            <p class="text-sm">
              Noch {{ formatTimeoutDisplay(timeoutRemaining) }} bis zum nächsten Versuch
            </p>
          </div>
        </div>
        ...
        <div v-if="errorMessage" class="mt-6">
          <div class="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
            ...
            <p v-if="attemptCount > 0" class="text-sm text-red-600 mt-2">
      ...
      <div class="mt-8 text-center text-sm text-wedding-500">
        <p>🎯 15 Haikus warten darauf, entdeckt zu werden</p>
